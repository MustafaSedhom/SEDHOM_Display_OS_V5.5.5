...
void SEDHOM_Pages::Start_new_page(bool show_back_arrow,WIFI_STATUS_t WIFI_state,BLUETOOTH_STATUS_t Bluetooth_state,int Battary_Value,Time_t time,Color_t Wifi_on,Color_t Wifi_off,Color_t BLE_color,Color_t Battary_color,Color_t Time_color,Color_t Reverse_color,Color_t Background)
{
  Widget.Big_frame_widget((Background==Color_Black)?Color_White:Color_Black,(Background==Color_Black)?Color_Black:Color_White);
  Widget.APP_Bar_Widget(show_back_arrow, WIFI_state, Bluetooth_state, Battary_Value, time, Wifi_on, Wifi_off, BLE_color, Battary_color, Time_color, Reverse_color, Background);
}
//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
