...
void SEDHOM_Pages::Start_new_page(bool show_back_arrow,WIFI_STATUS_t WIFI_state,BLUETOOTH_STATUS_t Bluetooth_state,int Battery_Value,Time_t time,Color_t Wifi_on,Color_t Wifi_off,Color_t BLE_color,Color_t Battery_color,Color_t Time_color,Color_t Reverse_color,Color_t Background)
{
