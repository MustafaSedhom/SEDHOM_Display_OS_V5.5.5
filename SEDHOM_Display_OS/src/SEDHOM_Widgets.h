...
class SEDHOM_Widgets
{
  ...
  public:
    ...
    // (true,WIFI_Status_conected_level_2_half,BLuetooth_Status_open_and_connected,20,{12,33,17,"Am"},Color_Blue,Color_DarkGrey,Color_Yellow,Color_Green,Color_Magenta,Color_Blue,OS.Mode());
    void APP_Bar_Widget(bool show_back_arrow = true,WIFI_STATUS_t WIFI_state = WIFI_Status_conected_level_2_half,BLUETOOTH_STATUS_t Bluetooth_state = BLuetooth_Status_open_and_connected,int Battary_Value = 22,Time_t time = {12,33,17,"Am"},Color_t Wifi_on = Color_Blue,Color_t Wifi_off= Color_DarkGrey,Color_t BLE_color= Color_Yellow,Color_t Battary_color = Color_Green,Color_t Time_color = Color_Magenta,Color_t Reverse_color = Color_Blue,Color_t Background=Color_Black);
