...
{
  Icon.fill_Rectangle(1,1,480-2,320-2,5,color);
  Icon.fill_Rectangle(1+2,1+2,480-2-4,320-2-4,5,Background);

  Icon.fill_Rectangle(1,60+3,480-2,3,5,color);
}
void SEDHOM_Widgets::ERROR_Massage_Widget(String masseage,Color_t Background,Color_t color,Color_t color_txt,Color_t ERROR_Massage_color ,Color_t title_Massage_color ,String title,bool filled_or_not ,int x ,int y ,int w ,int h ,int max_lines_of_masseage_error ,int max_char_in_one_line )
{
  ...
  Icon.fill_Rectangle(x_start+w-40,y_start,40,40,5,color);
  Icon.fill_Rectangle(x_start+w-40+3,y_start+3,40-6,40-6,5,Background);
  Icon.fill_Circle(x_start+w-40+20,y_start+20,6,RED);
  ...
  // draw Wrongmassage
  Icon.Warning_Icon({x_start+w-40,y_start+80,Color_Yellow,Background},RED,filled_or_not);
  ...
  // draw ok button
  Icon.fill_Rectangle(x_start+20,y_start+h-40,60,30,5,color);
  Icon.fill_Rectangle(x_start+20+3,y_start+h-40+3,60-6,30-6,5,Background);
  Icon.TEXT(x_start+32,y_start+h-18,BigFont,color_txt,"OK");
  // draw close button
  Icon.fill_Rectangle(x_start+w-80,y_start+h-40,60,30,5,color);
  Icon.fill_Rectangle(x_start+w-80+3,y_start+h-40+3,60-6,30-6,5,Background);
